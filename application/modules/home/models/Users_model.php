...
class Users_model extends CI_Model {
    ...
    var $table = USERS;
    var $column_order = array('uId','fullName','email','profileImage','businessName','socialType','status'); //set column field database for datatable orderable
    var $column_search = array('fullName','email','businessName'); //set column field database for datatable searchable
