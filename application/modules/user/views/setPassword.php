...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $backend;?>js/toastr/toastr.min.css">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    $uriSegment = $this->uri->segment(4);
     if(!empty($urisegment) && !empty($adminPass) && !empty($uriSegment)){ if($admin->forgetPass == $urisegment && md5($admin->userId) == $uriSegment){ ?>
    ...
    </form><?php } else{ ?> <center><span class="text-warning"></br><strong style="font-size:19px;><?php  echo "Your password link has been expired.";?></strong></span> </center> <?php } 

    } else { ?>
    <center><span class="text-warning"></br><strong style="font-size:19px;"><?php echo "Your password link has been expired."; ?> <?php } ?><strong></span></center>
