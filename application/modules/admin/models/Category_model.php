...
class Category_model extends CI_Model {
    ...
    var $column_order = array('categoryName','categoryId','categoryImage','status'); //set column field database for datatable orderable
    var $column_search = array('categoryId','categoryName'); //set column field database for datatable searchable
    ...
    function updateCategory($where,$data,$table){
        $this->db->set($data);
        $this->db->where($where);
