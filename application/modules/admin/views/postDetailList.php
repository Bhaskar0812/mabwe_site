 ...
 <?php if($comment_list){ foreach($comment_list as $key=> $values){?>
    ...
    if(!empty($values->profile_image)){ ?>
        ...
        <? }else {
             $imgPath = base_url().DEFAULT_IMAGE; ?>
              <img id="blah" class="img-responsive img-circle" src="<?php echo $imgPath; ?>" alt="User profile picture" width="100" height="100">
              <?php
            }  
        ?>
